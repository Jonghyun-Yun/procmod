...
#+property: header-args :eval never-export :eval no
...
#+RESULTS:
: Error in paste0(out_dir, "param_mean.csv") : object 'out_dir' not found
: Error in file.exists(param_path) : object 'param_path' not found
: Error: object 'dout' not found
: Error: object 'dout' not found
: Error: object 'dout' not found
: Error in paste0(out_dir, "input/item.csv") : object 'out_dir' not found
...
#+name: get_traits
#+begin_src R :results silent :tangle R/summary.R :noweb yes
source("R/pmean.R")
<<PUF_filter>>
...
** pre-proc + lpa
#+begin_src R :tangle R/run_lpa_compare.R :noweb yes
<<lpa_prep>>
...
#+name: lpa_res
#+begin_src R :noweb yes :tangle R/lpa_res.R
<<lpa_prep>>
...
#+begin_src jupyter-python :tangle py/collocation.py
import io
...
#+begin_src jupyter-python :results none :tangle py/collocation.py
...
#+begin_src R :noweb yes :tangle R/collocation.R :results none :eval no
<<lpa_prep>>
