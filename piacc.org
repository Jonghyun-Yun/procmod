...
[36m──[39m [1m[1mColumn specification[1m[22m [36m──────────────────────────────────────────────────────────────────[39m
cols(
  `Sequence in Dataset` = [32mcol_double()[39m,
  Name = [31mcol_character()[39m,
  Label = [31mcol_character()[39m,
  Type = [31mcol_character()[39m,
  Level = [31mcol_character()[39m,
  Width = [32mcol_double()[39m,
  Decimals = [32mcol_double()[39m,
  Domain = [31mcol_character()[39m,
  `Value scheme` = [31mcol_character()[39m,
  `Missing Scheme` = [31mcol_character()[39m,
  `Link to values` = [31mcol_character()[39m,
...
Joining by: Name
Error in ranger(y ~ ., data = mydd, num.trees = 500, mtry = min(4, ncol(mydd) -  : 
...
3                                                                              Age in 10 year bands (derived)
4                                                                       Age in 10 year bands (Trend-IALS/ALL)
5     Adult education/training population (AET) - excludes youths 16-24 in initial cycle of studies (derived)
6     Participated in formal AET for job-related reasons in 12 months preceding survey (see AETPOP - derived)
7 Participated in formal AET for non job-related reasons in 12 months preceding survey (see AETPOP - derived)
8                                             Interaction between adults' work and education status (derived)
  ranger_imp
1   98.69663
2  100.00000
3   68.39765
