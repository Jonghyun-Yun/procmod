...
#+begin_src R :exports results :var ob_out_dir=(jyun/get-nth-up-heading) :results output html
library(jyunr)
...
:END:
**** collocations
#+begin_src R :var out_dir="book_order/" :results html
for (class in c(3,2,1)) {
tt = read.delim(paste0(out_dir,"bi_ss_class_",class,".tsv"), header=F)
names(tt) = c("bigram","likelihood_ratio")
cat("## Class ", class, "\n")
print(knitr::kable(tt))
